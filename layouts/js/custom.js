...
const searchIconMarkup = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M18.3333 18.3333L13.3333 13.3333" stroke="#353535" stroke-width="1.6" stroke-linecap="round"/><path d="M8.33333 15.8333C12.158 15.8333 15.1667 12.8247 15.1667 9C15.1667 5.17526 12.158 2.16667 8.33333 2.16667C4.50859 2.16667 1.5 5.17526 1.5 9C1.5 12.8247 4.50859 15.8333 8.33333 15.8333Z" stroke="#353535" stroke-width="1.6"/></svg>`;
const closeIconMarkup = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M5.5 5.5L18.5 18.5M5.5 18.5L18.5 5.5" stroke="#353535" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`;
const searchIconMobileMarkup = `<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none"><path d="M16.0925 16.0925L20.1666 20.1666M1.83325 9.9814C1.83325 12.1424 2.69172 14.2149 4.21979 15.743C5.74786 17.2711 7.82038 18.1295 9.9814 18.1295C12.1424 18.1295 14.2149 17.2711 15.743 15.743C17.2711 14.2149 18.1295 12.1424 18.1295 9.9814C18.1295 7.82038 17.2711 5.74786 15.743 4.21979C14.2149 2.69172 12.1424 1.83325 9.9814 1.83325C7.82038 1.83325 5.74786 2.69172 4.21979 4.21979C2.69172 5.74786 1.83325 7.82038 1.83325 9.9814Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`;
